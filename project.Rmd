...
cp = cp + ggtitle("Cooks Distance Plot") + xlab("Observation Number") + ylab("Cook's Distance")
cp = cp + geom_hline(yintercept = (1/873), col = "red")
cp
```
...
e = e + geom_segment(aes(x=ERA, xend=ERA, y=HPO, yend=hpof.lm$fitted.values))
e
```
...
e = e + geom_point()
e = e + geom_smooth(method = 'lm')
e = e + geom_segment(aes(x=ERA, xend=ERA, y=hpof.lm$fitted.values, yend=mean(hpof.lm$fitted.values)))
e = e + geom_hline(aes(yintercept = mean(hpof.lm$fitted.values)))
e
```
...
e = e + geom_point()
#e = e + geom_smooth(method = 'lm')
e = e + geom_segment(aes(x=ERA, xend=ERA, y=HPO, yend=mean(hpof.lm$fitted.values)))
e = e + geom_hline(aes(yintercept = mean(hpof.lm$fitted.values)))
e
```
