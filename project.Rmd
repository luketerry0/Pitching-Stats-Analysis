...
a = createLowessForHPO(pt$W, "Wins")
b = createLowessForHPO(pt$ERA, "Earned Run Average")
c = createLowessForHPO(pt$BB, "Total Walks Given Up")
d = createLowessForHPO(pt$SO, "Strikeouts")
e = createLowessForHPO(pt$BAOpp, "Opponents Batting Average")
f = createLowessForHPO(pt$ER, "Earned Runs")
g = createLowessForHPO(pt$BB/pt$IPouts, "Total Walks Given Up Per Out")
h = createLowessForHPO(pt$BFP/pt$IPouts, "Batters Faced Per Out")
